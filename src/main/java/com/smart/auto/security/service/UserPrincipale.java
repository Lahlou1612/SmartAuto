...
public class UserPrincipale implements UserDetails {
	...
	public UserPrincipale(Long id, String name, String username, String email, String password,
	...
	public static UserPrincipale build(User user) {
		...
		return new UserPrincipale(user.getId(), user.getName(), user.getUsername(), user.getEmail(), user.getPassword(), authorities);
	}
